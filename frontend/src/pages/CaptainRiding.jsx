...
const CaptainRiding = () => {
  ...
  return (
    ...
    <div className="h-screen">
      ...
      <div className="h-1/5 p-6 flex items-center relative justify-between "
      onClick={() => {
      ...
      <div ref={finishRidePanelRef} className='fixed w-full h-screen z-10 bg-white translate-y-full bottom-0 px-3 py-6 pt-12'>
