...
const VehiclePanel = (props) => {
  return (
    <div>
      <h5 className='p-1 text-right w-[93%] absolute top-0' onClick={()=> {props.setVehiclePanel(false)}}><i className="text-3xl text-black-200 ri-arrow-down-wide-fill"></i></h5>
        ...
        <div onClick={() => {
          ...
          <h2 className='text-lg font-semibold'>₹194.30</h2>
        </div>
        <div onClick={() => {
            props.setConfirmRidePanel(true)
        }} className='flex p-3 border-2 active:border-black mb-2 rounded-xl w-full items-center justify-between'>
        ...
        <div onClick={() => {
          ...
          <h2 className='text-lg font-semibold'>₹112..68</h2>
        </div>
    </div>
  )
}
